  ...
  return (
    ...
    `}>
      ...
      <div className={`flex items-center gap-4 ${isMobile ? 'ml-12' : ''}`}>
        <h2 className={`
          font-bold bg-gradient-to-r from-blue-600 to-blue-900 bg-clip-text text-transparent
            ...
            <div className="flex items-center gap-2">
              {!isMobile && (
                <div className="text-right">
                  ...
                  <p className="text-xs text-blue-600">Computer Science</p>
                </div>
              )}
              <Image
