          ...
          <div className="relative">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-md hover:shadow-lg transition-shadow duration-200">
                ...
                <h3 className="text-lg text-gray-800 font-semibold mb-2">Interactive Learning</h3>
              ...
              <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-md hover:shadow-lg transition-shadow duration-200 mt-6 sm:mt-0">
                ...
                <h3 className="text-lg text-gray-800 font-semibold mb-2">Expert Mentors</h3>
              ...
              <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-md hover:shadow-lg transition-shadow duration-200">
                ...
                <h3 className="text-lg text-gray-800 font-semibold mb-2">Certification</h3>
              ...
              <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-md hover:shadow-lg transition-shadow duration-200 mt-6 sm:mt-0">
                ...
                <h3 className="text-lg text-gray-800 font-semibold mb-2">Flexible Schedule</h3>
